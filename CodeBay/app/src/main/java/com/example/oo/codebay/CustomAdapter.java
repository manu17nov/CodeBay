...
public class CustomAdapter extends RecyclerView.Adapter<Holder> {
    ...
    private ArrayList<LibraryModel> list_members = new ArrayList<>();
    ...
    public void onBindViewHolder(Holder holder, int position) {
        final LibraryModel list_item = list_members.get(position);
    ...
    private void shareLink(LibraryModel item) {
    ...
    public void setListContent(ArrayList<LibraryModel> list_members) {
