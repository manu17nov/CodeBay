...
public class FeedActivity extends AppCompatActivity {
    ...
    class FeedFetchTask extends AsyncTask<String, Void, ArrayList<LibraryModel>> {
        ...
        protected ArrayList<LibraryModel> doInBackground(String... strings) {
            String link = strings[0];
            InputStream inputStream = null;
            ArrayList<LibraryModel> feeds = new ArrayList<>();
            ...
            try {
                ...
                for (Feed feed : retreivedFeed) {
                    for (Item item : feed.getItems()) {
                        ...
                        feeds.add(new LibraryModel(item));
                        //testingw
        ...
        @Override
        protected void onPostExecute(ArrayList<LibraryModel> objects) {
    ...
    private void updateRecyclerFeeds(ArrayList<LibraryModel> modelArrayList) {
